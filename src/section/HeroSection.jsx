  ...
  return (
    <section onMouseEnter={() => setShowMute(true)} onMouseLeave={() => setShowMute(false)} className="min-h-[1056px] flex justify-center items-center text-white" id="hero">
      ...
      <div className="absolute z-10 bottom-0 right-10">
        <div onClick={() => setMuted(!muted)} className={`absolute z-20 cursor-pointer right-8 bottom-6 transition-opacity ease-in-out duration-300 text-white ${showMute ? "opacity-100" : "opacity-0"}`}>
          {muted ?
        ...
        <audio id="music" loop autoPlay muted={muted}>
